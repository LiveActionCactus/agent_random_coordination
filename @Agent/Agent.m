classdef Agent < handle
    ...
    properties
        ...
        map = struct( ...
            ...
            'decay_rt', 0.95, ...     % information decay rate
            'map', NaN ...             % lattice where points store "surveilled" state information [0,1] (least -> most informed)
            );             
        comms = struct( ...
    ...
    methods
        ...
        updateMap(obj, sim_itr);              % updates map based off comms
